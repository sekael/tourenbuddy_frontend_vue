# tour-linking Specification

## Purpose
Durable, two-sided link handshakes for same-objective tour collaboration among friends, with UI affordances to manage links and notifications for link-group lifecycle events.
