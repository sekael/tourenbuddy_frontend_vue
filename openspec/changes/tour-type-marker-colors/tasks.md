...
- [ ] 7.4 Check contrast on both "Base" vector and "Full Color" WMTS Swisstopo styles
...
- [ ] 8.4 Prompt the user to stage and commit with message:
...
- [ ] 8.5 Prompt the user to push the branch and open a PR against `main`, linking issue #13
